...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :doctors, 'Doctors', doctors_path, if: -> { current_user.owner? }
    primary.item :appointemnts, 'Appointemnts', appointments_path, if: -> { current_user.receptionist? }
    primary.item :pets, 'Pet', pets_path, if: -> { current_user.doctor? }
    primary.item :scheduled, 'Scheduled', customers_index_path, if: -> { current_user.customer? }
